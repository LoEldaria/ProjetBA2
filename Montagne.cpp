...
std :: array<unsigned int, 2> Montagne :: get_centre() const {return centre;}
unsigned int Montagne :: get_hauteur() const {return hauteur;}
std :: array<unsigned int, 2> Montagne ::get_sigma() const {return etalement_sigma; }
