...
//======================= Méthodes Vecteur2D =========================
array<double,2> Vecteur2D::get_vecteur()const{return vecteur;}
...
double Vecteur2D::norme2() const {
     return Vecteur2D(vecteur)*vecteur;
}
...
double Vecteur2D::operator*(const Vecteur2D& autre) const{
    Vecteur2D v(*this);
    double retour(0.0);
...
double Vecteur2D::operator[](unsigned int i)const{
    return i==0 or i==1 ? vecteur[i] : 0;
}
...
const Vecteur2D operator+(const Vecteur2D& vecteur, const Vecteur2D& autre){
    return Vecteur2D(vecteur)+=autre;
}
const Vecteur2D operator-(const Vecteur2D& vecteur){
    return Vecteur2D((-1)*vecteur);
}
const Vecteur2D operator-(const Vecteur2D& vecteur, const Vecteur2D& autre){
    return Vecteur2D(vecteur)-=autre;
}
const Vecteur2D operator*(const double valeur,const Vecteur2D& vecteur){
    return Vecteur2D(vecteur)*=valeur;
}
const Vecteur2D operator*(const Vecteur2D& vecteur, const double valeur){
    return Vecteur2D(vecteur)*=valeur;
}
const Vecteur2D operator~(const Vecteur2D& vecteur){
    return Vecteur2D(vecteur)*=(1/vecteur.norme());
}
